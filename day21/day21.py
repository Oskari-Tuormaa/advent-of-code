...
def part2(input_file: str):
    ...
    for code in codes:
        ...
        r2 = [r for rr in r1 for r in yield_press_buttons(DPAD, 'A'+rr)]
        r3 = [r for rr in r2 for r in yield_press_buttons(DPAD, 'A'+rr)]
        r4 = [r for rr in r3 for r in yield_press_buttons(DPAD, 'A'+rr)]
        r5 = [r for rr in r4 for r in yield_press_buttons(DPAD, 'A'+rr)]
        r6 = [r for rr in r5 for r in yield_press_buttons(DPAD, 'A'+rr)]
        r7 = [r for rr in r6 for r in yield_press_buttons(DPAD, 'A'+rr)]
        best = min(r7, key=lambda x: len(x))
        res += len(best) * extract_number(code)
